...
class IOHandler:
    def read_input(self, num):
        ...
        # file = open(f"./p2_tests/T{num}/input.txt", "r")  # for testing
    ...
    def write_lexical_errors(self, lexical_errors: Dict[int, List[Tuple[str, str]]]):
        # file = open(f"./p2_res/T{self.num}/lexical_errors.txt", "w+")  # for testing
    ...
    def write_tokens(self, tokens: Dict[int, List[Tuple[TokenType, str]]]):
        # file = open(f"./p2_res/T{self.num}/tokens.txt", "w+")  # for testing
    ...
    def write_symbol_tables(self, symbols: List[SymbolTableRow]):
        # file = open(f"./p2_res/T{self.num}/symbol_table.txt", "w+")  # for testing
